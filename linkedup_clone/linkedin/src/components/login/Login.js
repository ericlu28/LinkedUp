    ...
    <div className="login__container">
      <div className="login__welcome">
        <div className="login__logo">
          <img
            src="https://assets-global.website-files.com/5f3c19f18169b65d9d0bf384/5f3c19f18169b655820bf3d4_asset%2021.svg"
            alt="logo"
          />
        </div>
        <p>
          Build{" "}
          <span style={{ color: "#0B65C2", fontWeight: "bold" }}>Linkedin</span>{" "}
          with React
        </p>
      </div>
